...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((petUri = getIntent().getData()) == null) {
        ...
        if (!(TextUtils.isEmpty(nameString) || TextUtils.isEmpty(breedString) || TextUtils.isEmpty(weightString)
            ...
            if (petUri == null) {
                ...
                if (newUri == null)
                    ...
                    showToast(getString(R.string.editor_insert_pet_failed));
                else
                    // Otherwise, the insertion was successful and we can display a toast.
                    showToast(getString(R.string.editor_insert_pet_successful));
                ...
                if (rowsAffected == 0)
                    ...
                    showToast(getString(R.string.editor_update_pet_failed));
                else
                    // Otherwise, the update was successful and we can display a toast.
                    showToast(getString(R.string.editor_update_pet_successful));
            }

        } else showToast("Please enter valid pet data");
    }
    ...
    private void showDeleteConfirmationDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog
                ...
                .setPositiveButton(R.string.delete, (dialog, id) -> deletePet())
